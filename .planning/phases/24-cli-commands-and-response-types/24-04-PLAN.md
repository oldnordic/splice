...
must_haves:
  ...
  key_links:
    ...
    - from: "src/output.rs"
      ...
      via: "field name translation usage"
      pattern: "use crate::format::magellan"
---

<objective>
Create Magellan-compatible response types with translated field names (start_line vs line_start).

Purpose: DATA-03 (field translation) and DATA-04 (response types) requirements. Enable Magellan-compatible JSON output for delegated query commands using field translation utilities from Phase 22.
...
# Field translation utilities (Phase 22)
...
These types use Magellan field naming (start_line, not line_start) and provide From impls to convert from Phase 23 MagellanIntegration types.
  </action>
